            ...
            <div className='aboutContent'>
                ...
                <div className='aboutList'>
                    <div className='introAbout'>
                        <div className='introBox'>Hello, my name is Marika Mulder and I have recently completed the <i><b>Internet Applications and Web Development</b></i> program at Fanshawe College.</div>
